...
-- 3. What is the median current loan amount, annual income, and monthly debt by loan status?
...
-- 9. What is the impact of number of bankruptcies and tax liens on loan default rate?
SELECT
    CASE
